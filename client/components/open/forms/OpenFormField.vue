  ...
  methods: {
    ...
    inputProperties(field) {
      const inputProperties = {
        ...
        name: field.id,
        form: this.dataForm,
        label: (field.hide_field_name && (!field.hide_field_name_desktop)) ? null : field.name + ((this.shouldBeHidden) ? ' (Hidden Field)' : ''),
        color: this.form.color,
        placeholder: field.placeholder,
        help: field.help,
        helpPosition: (field.help_position) ? field.help_position : 'below_input',
        hideFieldNameDesktop: field.hide_field_name_desktop == 1 || field.hide_field_name_desktop == true,
